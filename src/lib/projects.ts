...
export const projects: Project[] = [
    {
        ...
        images: [
            {id: 1, image_name: 'Logo principal', image_url: '/isologo_elina.webp'},
            {id: 2, image_name: 'Mockup Taza', image_url: '/elina_taza.webp'},
            {id: 3, image_name: 'Mockup Bolsa de Café', image_url: '/bolsa_negra.webp'},
            {id: 4, image_name: 'Trama', image_url: '/patron_azul_elina.webp'},
            {id: 5, image_name: 'Mockup Vaso de Café', image_url: '/elina_vaso.webp'},
            {id: 6, image_name: 'Mockup Caja', image_url: '/caja_elina.webp'},
        ],
        alt:'Abuela Elina',
    ...
    },
    {
        ...
        images: [
            {id: 1, image_name: 'Logo principal', image_url: '/isologo_karen.webp'},
            {id: 2, image_name: 'Mockup redes', image_url: '/mockup_redes2_karen.webp'},
            {id: 3, image_name: 'Mockup libreta', image_url: '/libreta_karen.webp'},
            {id: 4, image_name: 'Mockup aviso', image_url: '/pendon_karen.webp'},
            {id: 5, image_name: 'Mockup redes', image_url: '/mockup_redes2_karen.webp'}
        ],
        alt: 'Karen jerez',
    ...
    },
    {
        ...
        images: [
            {id: 1, image_name:'Logo principal' , image_url: '/isologo_jesika.webp' },
            {id: 2, image_name:'Mockup tratamiento', image_url:'/mockup_crema_jesika.webp'},
            {id: 3, image_name:'Logo redes', image_url:'/jesika_studio_redes.webp'},
            {id: 4, image_name:'Mockup bolsa', image_url:'/mockup_bolsa_jesica.webp'},
            {id: 5, image_name:'Tarjeta', image_url:'/mockup_tarjeta_jesica.webp'},
            {id: 6, image_name:'Mockup aviso', image_url:'/mockup_letrero_jesica.webp'}
        ],
        alt: 'Jesica Studio',
    ...
    },
    {
        ...
        images: [
            {id: 1, image_name: 'Logo principal', image_url: '/isologo_recio.webp'},
            {id: 2, image_name: 'Logo redes', image_url: '/isologo_redes_recio.webp'},
            {id: 3, image_name: 'Mockup Totebag', image_url: '/mockup_bolsa_recio.webp'},
            {id: 4, image_name: 'Mockup camiseta', image_url: '/mockup_camiseta_recio.webp'},
            {id: 5, image_name: 'Mockup chaqueta', image_url: '/mockup_chaqueta_recio.webp'}
        ],
        alt: 'Recio',
        ...
        images: [
            {id: 1, image_name: 'Logo redes', image_url: '/isologo_uñas.webp'},
            {id: 2, image_name: 'Mockup agenda', image_url: '/mockup_libreta_paola.webp'},
            {id: 3, image_name: 'Mockup producto', image_url: '/mockup_esmalte_paola.webp'},
            {id: 4, image_name: 'Tarjeta', image_url: '/mockup_tarjeta_paola.webp'},
            {id: 5, image_name: 'Mockup aviso', image_url: '/mockup_aviso_paola.webp'},
        ],
        alt: 'Paola_Uñas',
